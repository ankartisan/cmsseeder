<div class="table-responsive">
    <table class="table table-hover">
        ...
        <tr>
            ...
            <th> <span class="cursor-pointer sort" data-sort="title"> Title <i class="fa fa-sort" aria-hidden="true"></i></span>  </th>
            <th> <span class="cursor-pointer sort" data-sort="slug"> Slug <i class="fa fa-sort" aria-hidden="true"></i> </span>  </th>
            <th> <span class="cursor-pointer sort" data-sort="template"> Template <i class="fa fa-sort" aria-hidden="true"></i> </span>  </th>
        ...
        @foreach($entities as $entity)
            <tr class="entity-row">
                ...
                <td>{{ $entity->status }}</td>
                <td class="action">
                    <a href="{{ route('admin.page', ['id' => $entity->id]) }}" class="btn btn-outline btn-sm btn-success">Edit</a>
                </td>
            </tr>
        @endforeach
        </tbody>
