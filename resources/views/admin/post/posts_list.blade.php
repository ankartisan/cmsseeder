<div class="table-responsive">
    <table class="table table-hover">
        ...
        <tr>
            ...
            <th> <span class="cursor-pointer sort" data-sort="user_id"> Owner <i class="fa fa-sort" aria-hidden="true"></i> </span>  </th>
        ...
        @foreach($entities as $entity)
            <tr class="entity-row">
                ...
                <td>{{ $entity->status }}</td>
                <td class="action">
                    <a href="{{ route('admin.post', ['id' => $entity->id]) }}" class="btn btn-outline btn-sm btn-success">Edit</a>
                </td>
            </tr>
        @endforeach
        </tbody>
