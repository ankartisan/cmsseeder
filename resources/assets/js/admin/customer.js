...
$("#update-customer").submit(function( event ) {
    ...
    if(data['id'] != undefined) { // UPDATE USER
        axios.put(base_api +'/customers/'+ data['id'], data)
        ...
        axios.post(base_api +'/customers', data)
            .then(function (response) {
...
$("#btn-delete-entity").on('click', function(evt) {
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                let user_id = $(this).attr("data-entity-id");
                axios.delete(base_api + '/customers/'+user_id, {})
                    .then(function (response) {
                        window.location.href = '/admin/customers';
                    })
                    .catch(function (error) {
...
$("#search-form").submit(function( event ) {
    ...
    window.history.pushState("ajax", "Search", base_api + '/customers?'+query);

    axios.get(base_api + '/customers/search?'+query)
        .then(function (response) {
